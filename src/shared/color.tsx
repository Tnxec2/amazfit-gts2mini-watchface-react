export default class Color {
    ...
    {
        if(color.length === 18) color = color.substring(0, 2) + color.substring(8, 18);
    ...
    /*
        from 16 bit background amazfit color to 32 bit
    */
    ...
    /*
    from 32 bit color to 16 bit amazfit color 
    */
